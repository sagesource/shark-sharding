...
public class SmartDataSourceTransactionManager extends AbstractPlatformTransactionManager implements ResourceTransactionManager, InitializingBean {
	 ...
	 * @see #setDataSource
	 */
	public SmartDataSourceTransactionManager() {
	 ...
	 */
	public SmartDataSourceTransactionManager(DataSource dataSource) {
		this();
	 ...
	 * <p>
	 * <b>The DataSource passed in here needs to return independent Connections.</b> The Connections may come from a pool (the typical case), but the DataSource must not return thread-scoped / request-scoped Connections or the like.
	 * 
	 * @see TransactionAwareDataSourceProxy
...
//				StrategyHolder.setAutocommit(Boolean.FALSE);
...
//		StrategyHolder.clearAutocommit();
